...
import ConfirmKickMemberModal from '@/components/modals/confirm-kick-member'
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export default function MembersModal() {
  ...
  const { onOpen: openConfirm, data: confirmData } = useConfirmModal()
  ...
  const doKick = async (memberId: string) => {
    try {
      setLoadingId(memberId)
  ...
  const onResult = async (result: boolean) => {
    if (result) {
      await doKick(confirmData.memberId!)
    }
  }
  ...
  return (
    <>
                    ...
                    <div className="ml-auto">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent side="left">
                          ...
                          <DropdownMenuItem
                            className="cursor-pointer"
                            onClick={() => openConfirm({ memberId: member.id })}
                          >
      ...
      <ConfirmKickMemberModal onResult={onResult} />
    </>
  )
}
